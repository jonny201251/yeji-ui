import { ArrayItems, ArrayTable, Form, FormItem, FormLayout, Input, Select, Space } from '@formily/antd'
...
export default (props) => {
  ...
  const SchemaField = createSchemaField({
    components: { FormLayout, FormItem, Input, Select, ArrayItems, ArrayTable, Space }
  })
          ...
          <SchemaField.Array name="checkList" x-decorator="FormItem" x-component="ArrayTable">
            <SchemaField.Object>
              ...
              <SchemaField.Void x-component="ArrayTable.Column" x-component-props={{ title: '考核项目' }}>
                <SchemaField.String
                  name="projectName" required x-decorator="FormItem"
                  x-component="Select"
